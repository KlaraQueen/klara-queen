/*! For license information please see main.fe976326.js.LICENSE.txt */
...
`,Ia=ga.li`
  ...
  cursor: pointer;
  font-size: ${e=>e.$vertical?"0.9rem":"clamp(0.48rem, 0.85vw, 0.70rem)"};
  white-space: nowrap;
  text-align: center;
  line-height: 1;
  ...
  @media (max-width: ${ba.tablet}px) {
    ...
    font-size: ${e=>e.$vertical?"0.9rem":"clamp(0.48rem, 0.8vw, 0.62rem)"};
...
//# sourceMappingURL=main.fe976326.js.map
...
`,bp=gr.span`
  flex: 1;
`,vp=e=>{let{title:t,features:n}=e;return(0,zr.jsxs)(gp,{children:[(0,zr.jsx)(pp,{children:t}),(0,zr.jsx)(wp,{children:n.map((e,t)=>(0,zr.jsxs)(yp,{children:[(0,zr.jsx)(xp,{children:"\u2713"}),(0,zr.jsx)(bp,{children:e})]},t))})]})},kp=gr.section`
  background: linear-gradient(
    135deg,
...
`;const Hp=function(){const[e,t]=(0,a.useState)(1),[n,r]=(0,a.useState)(6);(0,a.useEffect)(()=>{const e=()=>{const e=window.innerWidth<820;r(e?4:6)};return e(),window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),(0,a.useEffect)(()=>{window.scrollTo({top:0,behavior:"smooth"})},[e]);const i=Math.ceil(ll.length/n),o=(e-1)*n,l=o+n,s=ll.slice(o,l);return(0,zr.jsx)(Tp,{children:(0,zr.jsxs)(_p,{children:[(0,zr.jsxs)(Op,{children:[(0,zr.jsx)(Np,{children:"Aktualno\u015bci"}),(0,zr.jsx)(Rp,{children:"B\u0105d\u017a na bie\u017c\u0105co z najnowszymi wpisami z naszego bloga. Dzielimy si\u0119 wiedz\u0105 o technologii, designie i procesie tworzenia luksusowych do\u015bwiadcze\u0144 cyfrowych."})]}),(0,zr.jsx)(Mp,{children:s.map(e=>(0,zr.jsx)(Lp,{children:(0,zr.jsxs)(wt,{to:`/blog/${e.id}`,children:[(0,zr.jsx)(Dp,{src:e.image,alt:e.title}),(0,zr.jsxs)(Ap,{children:[(0,zr.jsx)(Ip,{children:e.date}),(0,zr.jsx)(Fp,{children:e.title}),(0,zr.jsx)(Up,{children:e.excerpt}),(0,zr.jsx)(Wp,{children:"Czytaj wi\u0119cej"})]})]})},e.id))}),(0,zr.jsx)(Ou,{currentPage:e,totalPages:i,onPageChange:e=>{t(e)}})]})})},Bp=gr.section`
  position: relative;
  z-index: 5;
  width: 100%;
`,Kp=gr.div`
...
`,wd=gr.span`
  font-size: 14px;
  color: ${br.testimonialSubtext};
`;const yd=function(){return(0,zr.jsxs)(od,{children:[(0,zr.jsxs)(ld,{children:[(0,zr.jsx)(sd,{children:"Opinie naszych klient\xf3w"}),(0,zr.jsx)(cd,{children:"Sprawd\u017a co m\xf3wi\u0105 o nas ci, kt\xf3rzy ju\u017c z nami pracowali"})]}),(0,zr.jsx)(ud,{children:Al.map(e=>(0,zr.jsxs)(pd,{children:[(0,zr.jsx)(dd,{children:[...Array(e.rating)].map((e,t)=>(0,zr.jsx)(fd,{children:"\u2605"},t))}),(0,zr.jsxs)(md,{children:['"',e.text,'"']}),(0,zr.jsxs)(hd,{children:[(0,zr.jsx)(gd,{children:e.name}),(0,zr.jsx)(wd,{children:e.company})]})]},e.id))})]})};const xd=function(){return(0,zr.jsxs)(Hi,{children:[(0,zr.jsx)(Wi,{}),(0,zr.jsx)(jr,{}),(0,zr.jsx)(di,{}),(0,zr.jsx)(Ui,{}),(0,zr.jsx)(Bi,{children:(0,zr.jsxs)(Le,{children:[(0,zr.jsx)(Re,{path:"/",element:(0,zr.jsx)(Fl,{})}),(0,zr.jsx)(Re,{path:"/about",element:(0,zr.jsx)(Ms,{})}),(0,zr.jsx)(Re,{path:"/offer",element:(0,zr.jsx)($p,{})}),(0,zr.jsx)(Re,{path:"/offer/:id",element:(0,zr.jsx)($p,{})}),(0,zr.jsx)(Re,{path:"/blog",element:(0,zr.jsx)(Hp,{})}),(0,zr.jsx)(Re,{path:"/blog/:id",element:(0,zr.jsx)(id,{})})," ",(0,zr.jsx)(Re,{path:"/testimonials",element:(0,zr.jsx)(yd,{})})," ",(0,zr.jsx)(Re,{path:"/questions",element:(0,zr.jsx)(qs,{})}),(0,zr.jsx)(Re,{path:"/cooperation",element:(0,zr.jsx)(Vc,{})})]})}),(0,zr.jsx)(Fi,{})]})};i.createRoot(document.getElementById("root")).render((0,zr.jsx)(a.StrictMode,{children:(0,zr.jsx)(ht,{basename:"/klara-queen",children:(0,zr.jsx)(xd,{})})}))})();
//# sourceMappingURL=main.7b6a5a1a.js.map
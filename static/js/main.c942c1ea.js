...
`,kl=ga.div`
  background: ${wa.testimonialBg};
  border: 1px solid ${wa.testimonialBorder};
  border-radius: 12px;
  padding: clamp(14px, 2vw, 20px);
  backdrop-filter: blur(10px);
  transition: all 0.3s ease;
  ...
  &:hover {
    ...
    border-color: ${wa.testimonialBorderHover};
...
`,Ad=ga.h1`
  ...
  font-weight: 700;
  background: linear-gradient(135deg, ${wa.testimonialAccent} 0%, #764ba2 100%);
...
//# sourceMappingURL=main.c942c1ea.js.map
/*! For license information please see main.39319503.js.LICENSE.txt */
...
`,qo=ga.a`
  ...
  background: linear-gradient(
    160deg,
    rgba(155, 45, 68, 0.45) 0%,
    rgba(75, 25, 45, 0.65) 40%,
    rgba(35, 10, 20, 0.8) 100%
  );
  border: 1px solid rgba(212, 175, 55, 0.24);
  box-shadow:
    inset 0 1px 0 rgba(255, 245, 220, 0.09),
  ...
  &:hover {
    ...
    background: linear-gradient(
      160deg,
      rgba(175, 55, 85, 0.55) 0%,
      rgba(95, 35, 60, 0.75) 40%,
      rgba(40, 15, 25, 0.9) 100%
    );
    box-shadow:
      0 4px 8px rgba(0, 0, 0, 0.32),
      0 12px 28px rgba(0, 0, 0, 0.46),
...
//# sourceMappingURL=main.39319503.js.map
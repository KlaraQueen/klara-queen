/*! For license information please see main.6cc252e7.js.LICENSE.txt */
...
`;const Aa=function(){return(0,za.jsx)(La,{to:"/","aria-label":Ra.ariaLabel,children:(0,za.jsx)(Ma,{})})},Da=ga.ul`
  ...
  @media (max-width: ${ba.tablet}px) {
    gap: ${e=>e.$vertical?"16px":"clamp(6px, 1.2vw, 12px)"};
    padding: 0;
    justify-content: ${e=>(e.$vertical,"center")};
    max-width: 100%;
  }
  ...
  @media (max-width: ${ba.phone}px) {
    gap: ${e=>e.$vertical?"14px":"clamp(4px, 0.8vw, 8px)"};
  }
`,Ia=ga.li`
  flex-shrink: 1;
  position: relative;
  ...
  letter-spacing: ${e=>e.$vertical?"1.1px":"clamp(0.6px, 0.1vw, 1.2px)"};
  cursor: pointer;
  font-size: ${e=>e.$vertical?"0.9rem":"clamp(0.58rem, 1.2vw, 0.82rem)"};
  white-space: nowrap;
  text-align: center;
  line-height: 1;
  padding: ${e=>e.$vertical?"2px 0":"clamp(3px, 0.5vw, 5px) clamp(6px, 1vw, 9px)"};
  border-radius: 10px;
  ...
  @media (max-width: ${ba.tablet}px) {
    letter-spacing: ${e=>e.$vertical?"1.1px":"0.7px"};
    font-size: ${e=>e.$vertical?"0.9rem":"clamp(0.58rem, 1.0vw, 0.72rem)"};
    padding: ${e=>e.$vertical?"1px 0":"clamp(3px, 0.3vw, 4px) clamp(5px, 0.8vw, 7px)"};
    white-space: nowrap;
  }

  @media (max-width: ${ba.phone}px) {
    letter-spacing: ${e=>e.$vertical?"0.9px":"0.6px"};
    font-size: ${e=>e.$vertical?"0.84rem":"clamp(0.54rem, 0.9vw, 0.66rem)"};
    padding: ${e=>e.$vertical?"1px 0":"clamp(3px, 0.2vw, 4px) clamp(4px, 0.6vw, 6px)"};
  }
...
`,Es=ga.p`
  ...
  font-weight: 400;
`,Ts=()=>(0,za.jsxs)(ws,{children:[(0,za.jsx)(vs,{children:Vl.title}),(0,za.jsx)(ks,{children:Vl.description}),(0,za.jsx)(zs,{children:Vl.platforms.map(e=>{const t=ni.find(t=>t.label===e.name);return(0,za.jsxs)(js,{href:null===t||void 0===t?void 0:t.url,target:"_blank",rel:"noopener noreferrer",children:[(0,za.jsx)(Ss,{children:t&&(0,za.jsx)(t.icon,{})}),(0,za.jsx)(Cs,{children:e.name}),(0,za.jsx)(Es,{children:e.description})]},e.id)})})]}),Ps=()=>(0,za.jsxs)(Ll,{children:[(0,za.jsx)(Zl,{}),(0,za.jsx)(Dl,{}),(0,za.jsxs)(Ml,{children:[(0,za.jsx)(Il,{children:ql}),(0,za.jsx)(Al,{children:(0,za.jsx)(rs,{})})]}),(0,za.jsx)(Dl,{}),(0,za.jsxs)(Ml,{children:[(0,za.jsx)(Il,{children:Ql}),(0,za.jsx)(Al,{style:{maxWidth:"1000px"},children:(0,za.jsx)(gs,{})})]}),(0,za.jsx)(Dl,{}),(0,za.jsxs)(Ml,{children:[(0,za.jsx)(Il,{children:Jl}),(0,za.jsx)(Al,{children:(0,za.jsx)(us,{})})]}),(0,za.jsx)(Dl,{}),(0,za.jsx)(Ts,{}),(0,za.jsx)(Dl,{}),(0,za.jsx)(bs,{})]}),$s=ga.section`
  position: relative;
  z-index: 5;
  width: 100%;
  min-height: 100vh;
...
`,Mc=ga.p`
  ...
  font-size: clamp(0.9rem, 1.6vw, 1rem);
  line-height: 1.7;
`,Ac=()=>(0,za.jsxs)(Tc,{children:[(0,za.jsx)(Pc,{children:Qs.guarantee.title}),(0,za.jsx)($c,{children:Qs.guarantee.subtitle}),(0,za.jsx)(_c,{children:Qs.guarantee.description}),(0,za.jsx)(Nc,{children:Qs.guarantee.benefits.map((e,t)=>(0,za.jsxs)(Oc,{children:[(0,za.jsx)(Rc,{children:e.icon}),(0,za.jsx)(Lc,{children:e.title}),(0,za.jsx)(Mc,{children:e.description})]},t))})]}),Dc=ga.div`
  display: flex;
  justify-content: center;
